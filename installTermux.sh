...
mkdir .shortcuts
mv dotfiles/youtubemp3/youtubemp3Termux.sh ${HOME}/.shortcuts && mv dotfiles/youtubeVideo/youtubeVideoTermux.sh ${HOME}/.shortcuts && mv dotfiles/.aria2 ${HOME} && mv ${HOME}/.aria2/aria2Termux.sh ${HOME}/.shortcuts
